<%@ Page Title="" Language="C#" MasterPageFile="~/Menu.Master" AutoEventWireup="true" CodeBehind="testCookies.aspx.cs" Inherits="WebApplication4.TestSesion" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table class="auto-style6">
        ...
        <tr>
            <td class="auto-style7">
                <asp:Button ID="Button3" runat="server"  Text="Supprimer" Width="267px" OnClick="Button3_Click" />
            </td>
            <td>&nbsp;</td>
        </tr>
        <tr>
